...
import { ChevronRightIcon, MoreHorizontalIcon } from '@lucide/vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<span${ssrRenderAttrs(mergeProps({
        ...
        role: "presentation",
        "aria-hidden": "true",
        class: unref(cn)("size-5 [&>svg]:size-4 flex items-center justify-center", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, () => {
        _push(ssrRenderComponent(unref(MoreHorizontalIcon), null, null, _parent));
      }, _push, _parent);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<li${ssrRenderAttrs(mergeProps({
        ...
        class: unref(cn)("gap-1 inline-flex items-center", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</li>`);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<ol${ssrRenderAttrs(mergeProps({
        ...
        class: unref(cn)("text-muted-foreground gap-1.5 text-xs flex flex-wrap items-center wrap-break-word", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</ol>`);
    };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderSlot(_ctx.$slots, "default", {}, () => {
        _push(ssrRenderComponent(unref(ChevronRightIcon), { class: "cn-rtl-flip" }, null, _parent));
      }, _push, _parent);
      _push(`</li>`);
    };
  }
...
export { _sfc_main$6 as _, _sfc_main$2 as a, _sfc_main$4 as b, _sfc_main$3 as c, _sfc_main as d, _sfc_main$1 as e };
//# sourceMappingURL=BreadcrumbSeparator-lo2iomjA.mjs.map
