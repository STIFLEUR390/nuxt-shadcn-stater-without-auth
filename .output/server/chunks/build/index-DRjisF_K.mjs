...
import { defineComponent, mergeProps, unref, withCtx, renderSlot, createVNode, resolveDynamicComponent, openBlock, createBlock, Fragment, createTextVNode, toDisplayString, ref, computed, createCommentVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrInterpolate, ssrRenderVNode, ssrRenderClass } from 'vue/server-renderer';
import { c as cn } from './server.mjs';
import { Primitive, createContext, TooltipProvider, useForwardPropsEmits, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, DialogRoot, DialogPortal, DialogContent, DialogClose, DialogTitle, DialogDescription, DialogOverlay, DialogTrigger } from 'reka-ui';
import { XIcon, PanelLeftIcon } from '@lucide/vue';
...
import { _ as _sfc_main$D } from './Input-DpdpNcLa.mjs';
import { _ as _sfc_main$E } from './Separator-2kwi4XBY.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(DialogOverlay), mergeProps({
        ...
        class: unref(cn)("bg-black/10 text-xs/relaxed supports-backdrop-filter:backdrop-blur-xs fixed inset-0 z-50 duration-100 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0", props.class)
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(DialogTitle), mergeProps({
        ...
        class: unref(cn)("text-foreground text-sm font-medium cn-font-heading", props.class)
      }, unref(delegatedProps), _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.collapsible === "none") {
        ...
        _push(ssrRenderComponent(unref(_sfc_main$B), mergeProps({ open: unref(openMobile) }, _ctx.$attrs, { "onUpdate:open": unref(setOpenMobile) }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(_sfc_main$y), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$v, { class: "sr-only" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        class: unref(cn)("no-scrollbar gap-0 flex min-h-0 flex-1 flex-col overflow-auto group-data-[collapsible=icon]:overflow-hidden", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div>`);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        class: unref(cn)("text-xs w-full", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div>`);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<ul${ssrRenderAttrs(mergeProps({
        ...
        "data-sidebar": "menu",
        class: unref(cn)("gap-0 flex w-full min-w-0 flex-col", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</ul>`);
    };
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        "data-slot": "skeleton",
        class: unref(cn)("bg-muted rounded-none animate-pulse", props.class)
      }, _attrs))}></div>`);
    };
  }
});
...
export { _sfc_main$j as _, _sfc_main as a, _sfc_main$p as b, _sfc_main$m as c, _sfc_main$i as d, _sfc_main$9 as e, _sfc_main$a as f, _sfc_main$6 as g, _sfc_main$4 as h, _sfc_main$5 as i, _sfc_main$s as j, _sfc_main$l as k, _sfc_main$r as l, _sfc_main$q as m, _sfc_main$2 as n, _sfc_main$3 as o, useSidebar as u };
//# sourceMappingURL=index-DRjisF_K.mjs.map
