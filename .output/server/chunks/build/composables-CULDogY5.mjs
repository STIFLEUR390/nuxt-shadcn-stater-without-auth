...
import { useForwardPropsEmits, DropdownMenuRoot, useForwardProps, DropdownMenuTrigger, DropdownMenuPortal, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuCheckboxItem, DropdownMenuItemIndicator, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger } from 'reka-ui';
import { CheckIcon, ChevronRightIcon } from '@lucide/vue';
import { reactiveOmit } from '@vueuse/core';
import { j as useState, c as cn } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(DropdownMenuLabel), mergeProps({
        ...
        class: unref(cn)("text-muted-foreground px-2 py-2 text-xs data-inset:pl-7", props.class)
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
...
export { _sfc_main$d as _, _sfc_main as a, _sfc_main$b as b, _sfc_main$a as c, _sfc_main$9 as d, _sfc_main$8 as e, _sfc_main$5 as f, useColorMode as u };
//# sourceMappingURL=composables-CULDogY5.mjs.map
