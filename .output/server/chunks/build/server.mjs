...
import { getCurrentScope, onScopeDispose, computed, defineComponent, shallowRef, getCurrentInstance as getCurrentInstance$1, provide, cloneVNode, h, createElementBlock, toRef, isRef, resolveComponent, inject, hasInjectionContext, unref, toValue, onServerPrefetch, reactive, ref, defineAsyncComponent, shallowReactive, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, mergeProps, withCtx, watch, createTextVNode, toDisplayString as toDisplayString$1, Transition, openBlock, createBlock, renderSlot, createCommentVNode, withModifiers, renderList, mergeDefaults, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, customRef, isReadonly, toRaw, isShallow, isReactive } from 'vue';
import { x as hasProtocol, y as isScriptProtocol, z as joinURL, A as parseQuery, B as appendResponseHeader, C as withBase, D as withQuery, E as sanitizeStatusCode, F as parseURL, j as encodePath, G as decodePath, H as getContext, I as withTrailingSlash, J as withoutTrailingSlash, $ as $fetch$1, K as baseURL, L as hash, M as defu, N as createHooks, c as createError$1, O as klona, P as getRequestHeader, Q as isEqual, R as setCookie, S as getCookie, T as deleteCookie, U as executeAsync, V as getRequestURL, W as createDefu, X as parsePath, Y as isEqual$1 } from '../nitro/nitro.mjs';
...
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderAttrs, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = { redirect: "/auth/keycloak/login" }, $1 = { redirect: "/auth/keycloak/logout" };
  return (m, p) => {
    let r = [];
...
const component_45stubV_Tza24bpMYdmmBhYuECxDa1B8DvWI7Ni_1TcfQr_WI = {};
const _routes = [
  {
    name: "admin-web-vitals___fr",
    path: "/admin/web-vitals",
    meta: { "middleware": ["admin"] },
    component: () => import('./web-vitals-D4PReIjs.mjs')
  },
  {
    name: "admin-web-vitals___en",
    path: "/en/admin/web-vitals",
    meta: { "middleware": ["admin"] },
    component: () => import('./web-vitals-D4PReIjs.mjs')
  },
  {
    name: "auth-confirm-password___fr",
    path: "/auth/confirm-password",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./confirm-password-D9Q9s9Au.mjs')
  },
  {
    name: "auth-confirm-password___en",
    path: "/en/auth/confirm-password",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./confirm-password-D9Q9s9Au.mjs')
  },
  {
    ...
    component: () => import('./forgot-password-CeQNe69I.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./login-DRjedUFI.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./reset-password-DmRozWAU.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./signup-sKWHPuJx.mjs')
  },
  {
  ...
  {
    name: "auth-verify-email___fr",
    path: "/auth/verify-email",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./verify-email-DGKY3DTD.mjs')
  },
  {
  ...
  },
  {
    name: "admin___fr",
    path: "/admin",
    component: () => import('./index-CusSTXEb.mjs')
  },
  {
    name: "admin___en",
    path: "/en/admin",
  ...
  {
    name: "openapi-demo___fr",
    path: "/openapi-demo",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./openapi-demo-D9gN08rc.mjs')
  },
  {
    name: "openapi-demo___en",
    path: "/en/openapi-demo",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./openapi-demo-D9gN08rc.mjs')
  },
  {
    name: "user___fr",
    path: "/user",
    component: () => import('./index-82GKIMgO.mjs')
  },
  {
    name: "user___en",
    path: "/en/user",
  ...
  },
  {
    ...
    component: () => import('./index-CuI-IDL6.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    ...
    path: "/auth/logout",
    component: component_45stubV_Tza24bpMYdmmBhYuECxDa1B8DvWI7Ni_1TcfQr_WI
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/en/auth/logout",
...
const namedMiddleware = {
  admin: () => import('./admin-f9u6nAZB.mjs')
};
...
function useOidcAuth() {
  ...
  async function login(provider, params) {
    ...
    await navigateTo(withBase(loginPath, baseURL2), { external: true, redirectCode: 302 });
  }
  async function logout(provider, logoutRedirectUri) {
    ...
    await navigateTo(withBase(logoutPath, baseURL2), { external: true, redirectCode: 302 });
...
const session_server_G7gCNi8Ijm4W01_xWmbmuAbJiF0Q86xv1SAcsw_0ZA0 = /* @__PURE__ */ defineNuxtPlugin({
  name: "session-fetch-plugin",
  enforce: "pre",
  async setup(nuxt) {
    let __temp, __restore;
    if (nuxt.payload.serverRendered) {
      [__temp, __restore] = executeAsync(() => useOidcAuth().fetch()), await __temp, __restore();
    }
  }
});
const reducers = [
...
const localeLoaders = {
  fr: [
    {
      key: "locale_fr_46json_74968ae1",
      load: () => import(
        './fr-De10Sou2.mjs'
        /* webpackChunkName: "locale_fr_46json_74968ae1" */
      ),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_ae781551",
      load: () => import(
        './en-Cl-du4C1.mjs'
        /* webpackChunkName: "locale_en_46json_ae781551" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { fr: "172c6a45", en: "172c6a45" };
...
var define_I18N_LOCALE_HASHES_default = { fr: "172c6a45", en: "172c6a45" };
...
const removeCookie = (name) => useCookie(name).value = void 0;
...
const plugin_rUDZiDyu2mz5GP9COOWWhZy5JxTjYdMqtxbGqnYBOkg = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
...
const authorization_abilities_UotIRBz5wXLU5G87iFBDo_KfuCRYFHlmfHMuXJ9fS_w = /* @__PURE__ */ defineNuxtPlugin({
...
const authorization_resolver_fga0p8APDwhW_Kgwsv2LwxKG03W_YWWkmw7JcFvBvds = /* @__PURE__ */ defineNuxtPlugin({
...
const pinia_unstorage_X8MTatnVxUFrrsUwLWwOz8oSyQ6SzXCXJUefMx13bz4 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.$pinia.use(
...
const plugins = [
  ...
  plugin$1,
  session_server_G7gCNi8Ijm4W01_xWmbmuAbJiF0Q86xv1SAcsw_0ZA0,
  ...
  authorization_abilities_UotIRBz5wXLU5G87iFBDo_KfuCRYFHlmfHMuXJ9fS_w,
  authorization_resolver_fga0p8APDwhW_Kgwsv2LwxKG03W_YWWkmw7JcFvBvds,
  pinia_unstorage_X8MTatnVxUFrrsUwLWwOz8oSyQ6SzXCXJUefMx13bz4,
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-3xZnW43q.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BFCooQmz.mjs').then((m) => m.default || m)),
  landing: defineAsyncComponent(() => import('./landing-B6OKPrmX.mjs').then((m) => m.default || m))
};
...
const _sfc_main$4 = {
  __name: "CookieClientOnlyPrerender",
  __ssrInlineRender: true,
  setup(__props) {
    const runtimeConfig = /* @__PURE__ */ useRuntimeConfig();
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/@dargmuesli/nuxt-cookie-control/dist/runtime/components/ClientOnlyPrerender.vue");
...
const _sfc_main$3 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const localeStrings = computed(() => moduleOptions.localeTexts[__props.locale]);
    const acceptAll = () => {
      setCookies({
    ...
    const getDescription = (description) => `${moduleOptions.isDashInDescriptionEnabled === false ? "" : "-"} ${resolveTranslatable(description, __props.locale)}`;
    const getName = (name) => {
      return name === "functional" ? localeStrings.value?.cookiesFunctional : resolveTranslatable(name, __props.locale);
    };
    const init = () => {
      nuxtApp.$cookies.locale.value = __props.locale;
    };
    const onModalClick = () => {
      ...
      (current, _previous) => {
        ...
        if (isConsentGiven.value) {
          ...
          for (const cookieEnabled of current || []) {
            ...
            const headElement = (void 0).getElementsByTagName("head")[0];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$4, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="cookieControl"${_scopeId}>`);
            if (!unref(isConsentGiven) && !unref(moduleOptions).isModalForced) {
              _push2(`<div class="${ssrRenderClass(`cookieControl__Bar cookieControl__Bar--${unref(moduleOptions).barPosition}`)}"${_scopeId}><div class="cookieControl__BarContainer"${_scopeId}><div${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "bar", {}, () => {
                _push2(`<h2${_scopeId}>${ssrInterpolate(localeStrings.value?.bannerTitle)}</h2><p${_scopeId}>${ssrInterpolate(localeStrings.value?.bannerDescription)}</p>`);
              }, _push2, _parent2, _scopeId);
              _push2(`</div><div class="cookieControl__BarButtons"${_scopeId}><button type="button"${_scopeId}>${ssrInterpolate(localeStrings.value?.accept)}</button>`);
              if (unref(moduleOptions).isAcceptNecessaryButtonEnabled) {
                _push2(`<button type="button"${_scopeId}>${ssrInterpolate(localeStrings.value?.decline)}</button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<button type="button"${_scopeId}>${ssrInterpolate(localeStrings.value?.manageCookies)}</button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(moduleOptions).isControlButtonEnabled && unref(isConsentGiven)) {
              _push2(`<button aria-label="Cookie control" class="cookieControl__ControlButton" data-testid="nuxt-cookie-control-control-button" type="button"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "controlButton", {}, () => {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path fill="currentColor" d="M510.52 255.82c-69.97-.85-126.47-57.69-126.47-127.86-70.17 0-127-56.49-127.86-126.45-27.26-4.14-55.13.3-79.72 12.82l-69.13 35.22a132.221 132.221 0 00-57.79 57.81l-35.1 68.88a132.645 132.645 0 00-12.82 80.95l12.08 76.27a132.521 132.521 0 0037.16 72.96l54.77 54.76a132.036 132.036 0 0072.71 37.06l76.71 12.15c27.51 4.36 55.7-.11 80.53-12.76l69.13-35.21a132.273 132.273 0 0057.79-57.81l35.1-68.88c12.56-24.64 17.01-52.58 12.91-79.91zM176 368c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm32-160c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm160 128c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32z"${_scopeId}></path></svg>`);
              }, _push2, _parent2, _scopeId);
              _push2(`</button>`);
            } else {
              _push2(`<!---->`);
            ...
            if (unref(isModalActive)) {
              ...
              if (isSaved.value) {
                _push2(`<p class="cookieControl__ModalUnsaved"${_scopeId}>${ssrInterpolate(localeStrings.value?.settingsUnsaved)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              if (!unref(moduleOptions).isModalForced) {
                _push2(`<button class="cookieControl__ModalClose" type="button"${_scopeId}>${ssrInterpolate(localeStrings.value?.close)}</button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(unref(CookieType), (cookieType) => {
                _push2(`<!--[-->`);
                if (unref(moduleOptions).cookies[cookieType].length) {
                  _push2(`<!--[--><h2${_scopeId}>${ssrInterpolate(
                    localeStrings.value && (cookieType === unref(CookieType).NECESSARY ? localeStrings.value.cookiesNecessary : localeStrings.value.cookiesOptional)
                  )}</h2><ul${_scopeId}><!--[-->`);
                  ssrRenderList(unref(moduleOptions).cookies[cookieType], (cookie) => {
                    _push2(`<li${_scopeId}>`);
                    ssrRenderSlot(_ctx.$slots, "cookie", mergeProps({ ref_for: true }, { cookie }), () => {
                      _push2(`<div class="cookieControl__ModalInputWrapper"${_scopeId}>`);
                      if (cookieType === unref(CookieType).NECESSARY && cookie.name !== "functional") {
                        _push2(`<input${ssrRenderAttr("id", unref(resolveTranslatable)(cookie.name, __props.locale))} type="checkbox" disabled checked${_scopeId}>`);
                      } else {
                        _push2(`<input${ssrRenderAttr("id", unref(resolveTranslatable)(cookie.name, __props.locale))} type="checkbox"${ssrIncludeBooleanAttr(
                          unref(getCookieIds)(localCookiesEnabled.value).includes(
                            cookie.id
                          )
                        ) ? " checked" : ""}${_scopeId}>`);
                      }
                      _push2(`<button type="button"${_scopeId}>${ssrInterpolate(getName(cookie.name))}</button><label class="cookieControl__ModalCookieName"${ssrRenderAttr("for", unref(resolveTranslatable)(cookie.name, __props.locale))} tabindex="0"${_scopeId}>${ssrInterpolate(getName(cookie.name))} `);
                      if (cookie.description) {
                        _push2(`<span${_scopeId}>${ssrInterpolate(getDescription(cookie.description))}</span>`);
                      } else {
                        _push2(`<!---->`);
                      }
                      if (unref(moduleOptions).isCookieIdVisible && cookie.targetCookieIds) {
                      ...
                      if (Object.entries(cookie.links || {}).length) {
                        ...
                        ssrRenderList(Object.entries(
                          ...
                          _push2(`<span${_scopeId}><br${_scopeId}>`);
                          _push2(ssrRenderComponent(_component_NuxtLink, {
                            to: entry2[0],
                            onClick: ($event) => !entry2[0].toLowerCase().startsWith("http") ? isModalActive.value = false : null
                          }, {
                            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                              if (_push3) {
                                _push3(`${ssrInterpolate(entry2[1] || entry2[0])}`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString$1(entry2[1] || entry2[0]), 1)
                                ];
                              }
                            }),
                            _: 2
              ...
              _push2(`<!--]--><div class="cookieControl__ModalButtons"${_scopeId}><button type="button"${_scopeId}>${ssrInterpolate(localeStrings.value?.save)}</button><button type="button"${_scopeId}>${ssrInterpolate(localeStrings.value?.acceptAll)}</button>`);
              if (!unref(moduleOptions).isModalForced) {
                _push2(`<button type="button"${_scopeId}>${ssrInterpolate(localeStrings.value?.declineAll)}</button>`);
              } else {
                _push2(`<!---->`);
              }
            ...
            return [
              createVNode("aside", { class: "cookieControl" }, [
                createVNode(Transition, {
                  name: `cookieControl__Bar--${unref(moduleOptions).barPosition}`
                }, {
                  default: withCtx(() => [
                    !unref(isConsentGiven) && !unref(moduleOptions).isModalForced ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: `cookieControl__Bar cookieControl__Bar--${unref(moduleOptions).barPosition}`
                    }, [
                      createVNode("div", { class: "cookieControl__BarContainer" }, [
                        createVNode("div", null, [
                          renderSlot(_ctx.$slots, "bar", {}, () => [
                            createVNode("h2", {
                              textContent: toDisplayString$1(localeStrings.value?.bannerTitle)
                            }, null, 8, ["textContent"]),
                            createVNode("p", {
                              textContent: toDisplayString$1(localeStrings.value?.bannerDescription)
                            }, null, 8, ["textContent"])
                          ])
                        ]),
                        createVNode("div", { class: "cookieControl__BarButtons" }, [
                          createVNode("button", {
                            type: "button",
                            onClick: ($event) => acceptAll(),
                            textContent: toDisplayString$1(localeStrings.value?.accept)
                          }, null, 8, ["onClick", "textContent"]),
                          unref(moduleOptions).isAcceptNecessaryButtonEnabled ? (openBlock(), createBlock("button", {
                            key: 0,
                            type: "button",
                            onClick: ($event) => acceptNecessary(),
                            textContent: toDisplayString$1(localeStrings.value?.decline)
                          }, null, 8, ["onClick", "textContent"])) : createCommentVNode("", true),
                          createVNode("button", {
                            type: "button",
                            onClick: ($event) => isModalActive.value = true,
                            textContent: toDisplayString$1(localeStrings.value?.manageCookies)
                          }, null, 8, ["onClick", "textContent"])
                        ])
                      ])
                ...
                unref(moduleOptions).isControlButtonEnabled && unref(isConsentGiven) ? (openBlock(), createBlock("button", {
                  key: 0,
                ...
                createVNode(Transition, { name: "cookieControl__Modal" }, {
                  default: withCtx(() => [
                    unref(isModalActive) ? (openBlock(), createBlock("div", {
                      ...
                      isSaved.value ? (openBlock(), createBlock("p", {
                        key: 0,
                        class: "cookieControl__ModalUnsaved",
                        textContent: toDisplayString$1(localeStrings.value?.settingsUnsaved)
                      ...
                      createVNode("div", { class: "cookieControl__ModalContent" }, [
                        createVNode("div", { class: "cookieControl__ModalContentInner" }, [
                          ...
                          !unref(moduleOptions).isModalForced ? (openBlock(), createBlock("button", {
                            key: 0,
                            class: "cookieControl__ModalClose",
                            type: "button",
                            onClick: ($event) => isModalActive.value = false,
                            textContent: toDisplayString$1(localeStrings.value?.close)
                          }, null, 8, ["onClick", "textContent"])) : createCommentVNode("", true),
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(CookieType), (cookieType) => {
                            return openBlock(), createBlock(Fragment, { key: cookieType }, [
                              unref(moduleOptions).cookies[cookieType].length ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                createVNode("h2", {
                                ...
                                createVNode("ul", null, [
                                  (openBlock(true), createBlock(Fragment, null, renderList(unref(moduleOptions).cookies[cookieType], (cookie) => {
                                    return openBlock(), createBlock("li", {
                                      key: cookie.id
                                    }, [
                                      renderSlot(_ctx.$slots, "cookie", mergeProps({ ref_for: true }, { cookie }), () => [
                                        createVNode("div", { class: "cookieControl__ModalInputWrapper" }, [
                                          cookieType === unref(CookieType).NECESSARY && cookie.name !== "functional" ? (openBlock(), createBlock("input", {
                                            key: 0,
                                            id: unref(resolveTranslatable)(cookie.name, __props.locale),
                                            type: "checkbox",
                                            disabled: "",
                                            checked: ""
                                            ...
                                            onChange: ($event) => toggleCookie(cookie)
                                          }, null, 40, ["id", "checked", "onChange"])),
                                          createVNode("button", {
                                            type: "button",
                                            onClick: ($event) => toggleButton($event)
                                          }, toDisplayString$1(getName(cookie.name)), 9, ["onClick"]),
                                          createVNode("label", {
                                            class: "cookieControl__ModalCookieName",
                                            for: unref(resolveTranslatable)(cookie.name, __props.locale),
                                            tabindex: "0",
                                            onKeydown: ($event) => toggleLabel($event)
                                          }, [
                                            createTextVNode(toDisplayString$1(getName(cookie.name)) + " ", 1),
                                            cookie.description ? (openBlock(), createBlock("span", { key: 0 }, toDisplayString$1(getDescription(cookie.description)), 1)) : createCommentVNode("", true),
                                            unref(moduleOptions).isCookieIdVisible && cookie.targetCookieIds ? (openBlock(), createBlock("span", { key: 1 }, [
                                              createVNode("br"),
                                              createTextVNode(" " + toDisplayString$1("IDs: " + cookie.targetCookieIds.map((id) => `"${id}"`).join(", ")), 1)
                                            ])) : createCommentVNode("", true),
                                            Object.entries(cookie.links || {}).length ? (openBlock(true), createBlock(Fragment, { key: 2 }, renderList(Object.entries(
                                              cookie.links || {}
                                            ), (entry2) => {
                          ...
                          createVNode("div", { class: "cookieControl__ModalButtons" }, [
                            createVNode("button", {
                              ...
                              textContent: toDisplayString$1(localeStrings.value?.save)
                            }, null, 8, ["onClick", "textContent"]),
                            createVNode("button", {
                              type: "button",
                              onClick: () => {
                              ...
                              textContent: toDisplayString$1(localeStrings.value?.acceptAll)
                            }, null, 8, ["onClick", "textContent"]),
                            !unref(moduleOptions).isModalForced ? (openBlock(), createBlock("button", {
                              key: 0,
                              type: "button",
                              onClick: () => {
                                unref(moduleOptions).declineAllAcceptsNecessary ? acceptNecessary() : acceptNone();
                                isModalActive.value = false;
                              },
                              textContent: toDisplayString$1(localeStrings.value?.declineAll)
                            }, null, 8, ["onClick", "textContent"])) : createCommentVNode("", true)
                          ])
                        ])
                      ])
...
const __nuxt_component_4 = Object.assign(_sfc_main$3, { __name: "CookieControl" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiToaster = _sfc_main$5;
      const _component_CookieControl = __nuxt_component_4;
      ...
      _push(ssrRenderComponent(_component_CookieControl, { locale: "fr" }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BsOQJxgc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BTOU6xVg.mjs'));
...
export { __nuxt_component_0$1 as _, useI18n as a, useOidcAuth as b, cn as c, useNuxtApp as d, entry_default as default, useRuntimeConfig as e, useFetch as f, useAsyncData as g, __nuxt_component_1$1 as h, defineNuxtRouteMiddleware as i, useState as j, navigateTo as n, useHead as u };
